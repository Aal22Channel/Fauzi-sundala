...
text: '```🚩 Akses Bot Ke Private Chat Di Tolak, Upgrade Premium Hanya 5.000 Idr Agar Bisa Bebas Akses Bot Dengan Hubungi Owner :\nwa.me/1(325)7667392\n\n• Join Ke Group Official Bot Untuk Free Akses & Informasi Kedepannya Tentang Bot : https://chat.whatsapp.com/LXobCYJolCFE1rETnyasom```',
contextInfo: {
mentionedJid: [m.sender, nomorown],
externalAdReply: { showAdAttribution: true, 
title: `LUCCANE MULTI DEVICE⚡`,
thumbnailUrl: 'https://telegra.ph/file/b9a6641a7447f84817609.jpg',
mediaType: 1,
        ...
        switch (action) {
            ...
            if (chat.welcome) {
                ...
                for (let user of participants) {
						let pp = 'https://telegra.ph/file/b9a6641a7447f84817609.jpg'
						let ppgc = 'https://telegra.ph/file/b9a6641a7447f84817609.jpg'
          ...
          quoted: null
                ...
                break                          
        case 'promote':
            text = (chat.sPromote || this.spromote || conn.spromote || '@user ```is now sepuh```')
        case 'demote':
            if (!text)
                text = (chat.sDemote || this.sdemote || conn.sdemote || '@user ```is no longer sepuh```')
...
global.dfail = (type, m, conn) => {
    let imgr = 'https://telegra.ph/file/b9a6641a7447f84817609.jpg'
    let msg = {
