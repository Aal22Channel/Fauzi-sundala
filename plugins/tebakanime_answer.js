...
handler.before = async function (m) {
  ...
  if (m.quoted.id == this.tebakanime[id][0].id) {
    ...
    if (m.text.toLowerCase() == json.jawaban.toLowerCase().trim()) {
      ...
      await conn.sendImageAsSticker(m.chat, 'https://telegra.ph/file/ba14f31a89695620007c7.png', m, { packname: "sticker by", author: "devv" })
      setTimeout(() => {
    ...
    else await conn.sendImageAsSticker(m.chat, 'https://telegra.ph/file/6059151f81fb30d3a5351.png', m, { packname: "sticker by", author: "devv" })
  }
  return !0
}
handler.exp = 0
